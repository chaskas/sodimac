CREATE TABLE aplicacion (id BIGINT AUTO_INCREMENT, descripcion VARCHAR(50), PRIMARY KEY(id)) ENGINE = INNODB;
...
CREATE TABLE funcion (id BIGINT AUTO_INCREMENT, id_aplicacion BIGINT NOT NULL, descripcion VARCHAR(50), INDEX id_aplicacion_idx (id_aplicacion), PRIMARY KEY(id)) ENGINE = INNODB;
