...
CREATE TABLE oportunidad_cmr (id_opor_cmr INT AUTO_INCREMENT, sku VARCHAR(7), nombre_producto VARCHAR(200), precio_internet BIGINT, unidad_med_int VARCHAR(10), precio_cmr INT, unidad_med_cmr VARCHAR(10), fecha_vig_des DATETIME, fecha_vig_has DATETIME, id_pais INT, INDEX id_pais_idx (id_pais), PRIMARY KEY(id_opor_cmr)) ENGINE = INNODB;
