...
CREATE TABLE endpoint (id_endpoint INT AUTO_INCREMENT, cod_endpoint VARCHAR(6), desc_endpoint VARCHAR(40), host VARCHAR(30), puerto INT, resto_url VARCHAR(200), id_pais INT, INDEX id_pais_idx (id_pais), PRIMARY KEY(id_endpoint)) ENGINE = INNODB;
