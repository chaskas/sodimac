...
CREATE TABLE endpoint (id_endpoint INT AUTO_INCREMENT, cod_endpoint VARCHAR(10), desc_endpoint VARCHAR(40), host VARCHAR(30), puerto INT, resto_url VARCHAR(200), id_pais INT, version BIGINT DEFAULT 0, INDEX id_pais_idx (id_pais), PRIMARY KEY(id_endpoint)) ENGINE = INNODB;
...
ALTER TABLE funcion ADD CONSTRAINT funcion_id_aplicacion_aplicacion_id FOREIGN KEY (id_aplicacion) REFERENCES aplicacion(id) ON DELETE CASCADE;
